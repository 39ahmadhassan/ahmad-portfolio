...
const menuList = [
  { id: 1, path: "/", name: "Home" },
  { id: 2, path: "/", section: "#about", name: "About" },
  { id: 3, path: "/", section: "#projects", name: "Work" },
  {
    id: 4,
    path: "/",
    section: "#services",
    name: "Services",
    dropDown: [
      { id: 1, path: "/all-services", name: "Services" },
      { id: 2, path: "/service-details", name: "Service Details" },
    ],
  },
  { id: 5, path: "/", section: "#testimonial", name: "Testimonial" },
  {
    id: 6,
    path: "/",
    section: "#blog",
    name: "Blog",
    dropDown: [
      { id: 1, path: "/all-blog", name: "Blog" },
      { id: 2, path: "/blog-details", name: "Blog Details" },
    ],
  },
...
const Header = () => {
  ...
  const handleHeaderToggle = () => setMenuActive(!menuActive);
      ...
      <div className="container">
        <div className="header-wrapper">
            ...
            {menuList.map(({ id, name, path, dropDown, section }) => (
              <li key={id} onClick={() => handleSubMenu(id)}>
                ...
                {Array.isArray(dropDown) && dropDown.length > 0 && (
                  ...
                  >
                    {dropDown.map(({ id: subId, name, path }) => (
                      <li key={subId}>
          ...
          <div className="menu__components d-flex align-items-center">
            ...
            <div onClick={() => setIsSidebarActive(true)} className="remove__click">
              <List className="icon" />
            </div>
          </div>
        </div>
