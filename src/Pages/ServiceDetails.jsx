...
// ✅ Import your services list
import { serviceList } from "../Components/Services/Services"; // adjust this path if needed
          ...
          <div className="row g-4">
            <div className="col-lg-8">
              <div className="ser__left__details">
                ...
                {/* ✅ Dynamic Title & About Text */}
                <div className="text__box mb__cus60" data-aos="fade-up" data-aos-duration="1400">
                  <h3 className="textt36 d-block">About {service?.heading}</h3>
                  <p className="fz-16 pra ttext__one">
                    {service?.para}
                  </p>
                  <p className="fz-16 pra">
                    This service includes complete {service?.subHeading} solutions with best practices, performance optimization and modern development strategy.
                  </p>
                </div>

                {/* ✅ Keep your existing static text below */}
                <div className="text__box mb__cus60" data-aos="fade-up" data-aos-duration="1400">
            ...
            {/* ✅ Sidebar – You can later make these dynamic too */}
            <div className="col-lg-4">
              <div className="service__right__wrap">
                <div className="service__rightbox mb-30">
                  <h3>Service List</h3>
                  {serviceList.map((s) => (
                    <a key={s.id} href={`/service-details/${s.id}`} className="link__box mb-15">
                      {s.heading}
